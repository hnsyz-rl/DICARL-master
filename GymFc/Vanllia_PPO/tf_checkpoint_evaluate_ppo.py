...
if __name__ == "__main__":
    ...
    ckpt_dir = '../log/gymfc_nf-step-v1/PPO'
    ...
    if noise_flig:
        eval_dir = args.eval_dir if args.eval_dir else os.path.join(model_dir, "ppo_evaluations_noise")
    else:
        eval_dir = args.eval_dir if args.eval_dir else os.path.join(model_dir, "ppo_evaluations")
