...
def train(env, num_timesteps, seed, ckpt_dir=None, action_clip=True,
    ...
    Vanllia_PPO.learn(env, policy_fn,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', default="../log/gymfc_nf-step-v1/0602/Vanllia_PPO",
    ...
    parser.add_argument('--ckpt-freq', type=int, default=1e5)
    ...
    train(env, timesteps, seed, ckpt_dir = ckpt_dir, render = render, action_clip=action_clip,
