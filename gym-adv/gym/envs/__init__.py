...
register(
    id='HopperTorso_ThighAdv-v1',
    entry_point='gym.envs.adversarial.mujoco:HopperTorso_ThighEnv',
    reward_threshold=3800.0,
)
...
#register(
#    id='CartPoleAdv-v0',
#    entry_point='gym.envs.adversarial.classic_control:CartPoleEnv',
#    timestep_limit=200,
...
#
#register(
#    id='MountainCarAdv-v0',
#    entry_point='gym.envs.adversarial.classic_control:MountainCarEnv',
#    timestep_limit=200,
#    reward_threshold=-110.0,
#)
#
#register(
#    id='MountainCarContinuousAdv-v0',
#    entry_point='gym.envs.adversarial.classic_control:Continuous_MountainCarEnv',
#    timestep_limit=999,
...
#register(
#    id='PendulumAdv-v0',
#    entry_point='gym.envs.adversarial.classic_control:PendulumEnv',
#    timestep_limit=200,
#)
#
#register(
#    id='AcrobotAdv-v1',
#    entry_point='gym.envs.adversarial.classic_control:AcrobotEnv',
#    timestep_limit=500,
#)
