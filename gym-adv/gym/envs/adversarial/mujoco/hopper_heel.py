...
class HopperHeelEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        ## Adversarial setup
        self._adv_f_bname = [b'torso', b'leg'] #Byte String name of body on which the adversary force will be applied  # 躯干施力
        print('adv torso-foot')
        ...
        print('Env-Info: Hopper Torso-Leg')
